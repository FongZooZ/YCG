...
public class AbilityUtil {
  ...
  public static AbilityComponent abilityComponentFilled(String abilities, AbilityComponent component) {
    ...
    component.setAbilitiesOrder(orderAbility);
    return component;
  }
  ...
  public static ArrayList<String> getOrderAbility(ObjectMap<String, AbilityInfo> abilityMaps) {
    ArrayList<String> abilitiesOrder = new ArrayList<String>();
    for (ObjectMap.Entry<String, AbilityInfo> abilityMap : abilityMaps) {
      abilitiesOrder.add(abilityMap.key);
    }
